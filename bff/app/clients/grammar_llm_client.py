...
- 주어진 문장 안에서 판단 가능한 **주체 높임, 객체 높임** 오류
...
- 종결어미를 수정해야 하는 문법적 오류가 있을 경우에도, **원래 문장의 어체(해요체, 하십시오체 등)**를 반드시 그대로 유지해야 합니다.
  - 원문이 -다로 끝나면 교정문도 -다로, -요로 끝나면 교정문도 -요로 끝나야 합니다.
- 형용사(많다, 작다, 크다 등)에 높임 표현(-습니다, -어요 등)을 임의로 적용하는 것은 교정 대상이 아닙니다.
